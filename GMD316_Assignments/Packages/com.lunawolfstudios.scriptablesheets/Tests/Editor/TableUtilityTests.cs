...
namespace LunaWolfStudiosEditor.ScriptableSheets.EditorTests
{
	...
	public class TableUtilityTests
	{
		...
		[Test]
		public void FromFlatFileFormat_RemovesHeaderRowWhenNamesDifferAndDataIsNumeric()
		{
			var propertyTable = GetEmptyTable(3, 2);
			var flatFileContent = "Health,Mana\n10,20\n30,40\n50,60";
			...
			Assert.AreEqual("10", propertyTable.Get(0, 0).GetProperty(formatSettings));
			Assert.AreEqual("20", propertyTable.Get(0, 1).GetProperty(formatSettings));
			Assert.AreEqual("30", propertyTable.Get(1, 0).GetProperty(formatSettings));
			Assert.AreEqual("40", propertyTable.Get(1, 1).GetProperty(formatSettings));
			Assert.AreEqual("50", propertyTable.Get(2, 0).GetProperty(formatSettings));
			Assert.AreEqual("60", propertyTable.Get(2, 1).GetProperty(formatSettings));
		}

		[Test]
		public void FromFlatFileFormat_KeepsFirstRowWhenNamesDifferAndDataIsAllStrings()
		{
			var propertyTable = GetEmptyTable(3, 2);
			var flatFileContent = "Alpha,Beta\nGamma,Delta\nEpsilon,Zeta";
			...
			Assert.AreEqual("Alpha", propertyTable.Get(0, 0).GetProperty(formatSettings));
			Assert.AreEqual("Beta", propertyTable.Get(0, 1).GetProperty(formatSettings));
			Assert.AreEqual("Gamma", propertyTable.Get(1, 0).GetProperty(formatSettings));
			Assert.AreEqual("Delta", propertyTable.Get(1, 1).GetProperty(formatSettings));
			Assert.AreEqual("Epsilon", propertyTable.Get(2, 0).GetProperty(formatSettings));
			Assert.AreEqual("Zeta", propertyTable.Get(2, 1).GetProperty(formatSettings));
		}

		[Test]
		public void FromFlatFileFormat_KeepsFirstRowWhenColumnCountDiffers()
		{
			var propertyTable = GetEmptyTable(3, 2);
			var flatFileContent = "Health,Mana\n10,20\n30,40";
			...
			Assert.AreEqual("Health", propertyTable.Get(0, 0).GetProperty(formatSettings));
			Assert.AreEqual("Mana", propertyTable.Get(0, 1).GetProperty(formatSettings));
			Assert.AreEqual("10", propertyTable.Get(1, 0).GetProperty(formatSettings));
			Assert.AreEqual("20", propertyTable.Get(1, 1).GetProperty(formatSettings));
		}

		[Test]
		public void FromFlatFileFormat_AlwaysStripRemovesFirstRowWhenNamesDiffer()
		{
			var propertyTable = GetEmptyTable(3, 2);
			var flatFileContent = "Alpha,Beta\nGamma,Delta\nEpsilon,Zeta";
			...
			Assert.AreEqual("Gamma", propertyTable.Get(0, 0).GetProperty(formatSettings));
			Assert.AreEqual("Delta", propertyTable.Get(0, 1).GetProperty(formatSettings));
			Assert.AreEqual("Epsilon", propertyTable.Get(1, 0).GetProperty(formatSettings));
			Assert.AreEqual("Zeta", propertyTable.Get(1, 1).GetProperty(formatSettings));
		}

		[Test]
		public void FromFlatFileFormat_AlwaysStripRemovesFirstRowWhenSingleRow()
		{
			var propertyTable = GetEmptyTable(3, 2);
			var flatFileContent = "Alpha,Beta";
		...
		[Test]
		public void FromFlatFileFormat_RemovesHeaderRowWithColumnIndexPrefix()
		{
			var propertyTable = GetEmptyTable(3, 2);
			var flatFileContent = "0 column-1,1 column-2\nrow1-col1,row1-col2\nrow2-col1,row2-col2\nrow3-col1,row3-col2";
		...
		[Test]
		public void FromFlatFileFormat_KeepsColumnIndexPrefixedHeaderWhenDisabled()
		{
			var propertyTable = GetEmptyTable(3, 2);
			var flatFileContent = "0 column-1,1 column-2\nrow1-col1,row1-col2\nrow2-col1,row2-col2\nrow3-col1,row3-col2";
			...
			var formatSettings = new FlatFileFormatSettings()
			{
				...
				ColumnDelimiter = ",",
				ColumnHeaders = new string[] { "column-1", "column-2" },
				HeaderColumnIndex = false,
			};

			propertyTable.FromFlatFileFormat(flatFileContent, formatSettings);

			Assert.AreEqual("0 column-1", propertyTable.Get(0, 0).GetProperty(formatSettings));
			Assert.AreEqual("1 column-2", propertyTable.Get(0, 1).GetProperty(formatSettings));
			Assert.AreEqual("row1-col1", propertyTable.Get(1, 0).GetProperty(formatSettings));
			Assert.AreEqual("row1-col2", propertyTable.Get(1, 1).GetProperty(formatSettings));
			Assert.AreEqual("row2-col1", propertyTable.Get(2, 0).GetProperty(formatSettings));
			Assert.AreEqual("row2-col2", propertyTable.Get(2, 1).GetProperty(formatSettings));
		}
		...
		[Test]
		public void GetFlatFileRowCount_CountsRows()
		{
			var flatFileContent = "row1-col1,row1-col2\nrow2-col1,row2-col2\nrow3-col1,row3-col2";
			...
			Assert.AreEqual(3, TableUtility.GetFlatFileRowCount(flatFileContent, formatSettings));
		}

		[Test]
		public void GetFlatFileRowCount_CountsSingleRow()
		{
			var flatFileContent = "row1-col1,row1-col2";
			...
			Assert.AreEqual(1, TableUtility.GetFlatFileRowCount(flatFileContent, formatSettings));
		}

		[Test]
		public void GetFlatFileRowCount_ExcludesHeaderRow()
		{
			var flatFileContent = "column-1,column-2\nrow1-col1,row1-col2\nrow2-col1,row2-col2\nrow3-col1,row3-col2";
		...
		[Test]
		public void GetFlatFileRowCount_IncludesUnmatchedHeaderRow()
		{
			var flatFileContent = "row1-col1,row1-col2\nrow2-col1,row2-col2\nrow3-col1,row3-col2";
		...
		[Test]
		public void GetFlatFileRowCount_RemovesEmptyRows()
		{
			var flatFileContent = "row1-col1,row1-col2\n\nrow2-col1,row2-col2\n\n\nrow3-col1,row3-col2\n";
		...
		[Test]
		public void GetFlatFileRowCount_CountsWrappedRows()
		{
			var flatFileContent = "\"row1-col1\",\"row1-col2\"\n\"row2-col1\",\"row2-col2\"\n\"row3-col1\",\"row3-col2\"";
		...
		[Test]
		public void GetFlatFileRowCount_ReturnsZeroForEmptyContent()
		{
			var formatSettings = new FlatFileFormatSettings()
			{
				RowDelimiter = "\n",
			...
			Assert.AreEqual(0, TableUtility.GetFlatFileRowCount(string.Empty, formatSettings));
			Assert.AreEqual(0, TableUtility.GetFlatFileRowCount(null, formatSettings));
		}

		[Test]
		public void GetJsonRowCount_CountsEntries()
		{
			var json = new StringBuilder();
			json.AppendLine("{");
			json.AppendLine("  \"Object0\": {");
			json.AppendLine("    \"Property1\": \"Object0-Value1\"");
			json.AppendLine("  },");
			json.AppendLine("  \"Object1\": {");
			json.AppendLine("    \"Property1\": \"Object1-Value1\"");
			json.AppendLine("  }");
			json.Append("}");

			Assert.AreEqual(2, TableUtility.GetJsonRowCount(json.ToString()));
		}

		[Test]
		public void GetJsonRowCount_ReturnsZeroForEmptyContent()
		{
			Assert.AreEqual(0, TableUtility.GetJsonRowCount(string.Empty));
			Assert.AreEqual(0, TableUtility.GetJsonRowCount(null));
		}
