...
namespace LunaWolfStudiosEditor.ScriptableSheets.EditorTests
{
	...
	public class PaginatorTests
	{
		...
		[Test]
		public void SetCurrentPage_ShouldClampWithinValidRange()
		{
			var paginator = new Paginator(5, 20);
		...
		[Test]
		public void GetTotalPages_ShouldReturnZeroWhenObjectsPerPageIsZero()
		{
			var paginator = new Paginator();
			Assert.AreEqual(0, paginator.GetTotalPages());
		}
