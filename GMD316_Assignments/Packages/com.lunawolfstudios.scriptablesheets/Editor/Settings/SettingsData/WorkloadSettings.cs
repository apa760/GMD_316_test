...
namespace LunaWolfStudiosEditor.ScriptableSheets
{
	...
	public class WorkloadSettings : AbstractBaseSettings, IScriptableSettings
	{
		...
		[SerializeField]
		private int m_AssetPreviewDepth;
		public int AssetPreviewDepth { get => m_AssetPreviewDepth; set => m_AssetPreviewDepth = value; }

		[SerializeField]
		private int m_CollectionTableDepth;
		public int CollectionTableDepth { get => m_CollectionTableDepth; set => m_CollectionTableDepth = value; }
		...
		public WorkloadSettings()
		{
			...
			m_AssetPreviewDepth = 3;
			m_CollectionTableDepth = 3;
		...
		protected override void DrawProperties(SerializedObject target)
		{
			...
			m_AssetPreviewDepth = EditorGUILayout.IntSlider(SettingsContent.DigitField.AssetPreviewDepth, m_AssetPreviewDepth, 1, 10);
			m_CollectionTableDepth = EditorGUILayout.IntSlider(SettingsContent.DigitField.CollectionTableDepth, m_CollectionTableDepth, 1, 10);
