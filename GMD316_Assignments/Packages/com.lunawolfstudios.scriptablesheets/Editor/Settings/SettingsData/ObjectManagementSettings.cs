...
namespace LunaWolfStudiosEditor.ScriptableSheets
{
	...
	public class ObjectManagementSettings : AbstractBaseSettings, IScriptableSettings
	{
		...
		[SerializeField]
		private bool m_ConfirmGeneration;
		public bool ConfirmGeneration { get => m_ConfirmGeneration; set => m_ConfirmGeneration = value; }
		...
		{
			m_AutoGenerate = EditorGUILayout.Toggle(SettingsContent.Toggle.AutoGenerate, m_AutoGenerate);
			if (m_AutoGenerate)
			{
				SheetLayout.Indent();
				m_ConfirmGeneration = EditorGUILayout.Toggle(SettingsContent.Toggle.ConfirmGeneration, m_ConfirmGeneration);
			...
			m_Scan.ScanHiddenSubAssets = EditorGUILayout.Toggle(SettingsContent.Toggle.ScanHiddenSubAssets, m_Scan.ScanHiddenSubAssets);
