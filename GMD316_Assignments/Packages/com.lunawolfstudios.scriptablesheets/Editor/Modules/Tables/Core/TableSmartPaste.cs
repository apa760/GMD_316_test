...
namespace LunaWolfStudiosEditor.ScriptableSheets.Tables
{
	public class TableSmartPaste<T> where T : ITableProperty
	{
		...
		/// <summary>
		/// The captured paste content, falling back to the system copy buffer. Used to inspect the paste before it is applied.
		/// </summary>
		public string PasteContent => m_PasteContent ?? EditorGUIUtility.systemCopyBuffer;
