...
namespace LunaWolfStudiosEditor.ScriptableSheets.Tables
{
	...
	public struct FlatFileFormatSettings
	{
		...
		[SerializeField]
		private bool m_AlwaysStrip;
		public bool AlwaysStrip { get => m_AlwaysStrip; set => m_AlwaysStrip = value; }

		[SerializeField]
		private bool m_HeaderColumnIndex;
		public bool HeaderColumnIndex { get => m_HeaderColumnIndex; set => m_HeaderColumnIndex = value; }
